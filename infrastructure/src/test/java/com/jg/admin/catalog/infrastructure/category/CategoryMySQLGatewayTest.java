...
public class CategoryMySQLGatewayTest {
    ...
    public void givenAValidCategory_whenCallsUpdate_shouldReturnCategoryUpdated(){
        ...
        final var anUpdatedCategory = aCategory.clone().update(expetedName, expectedDescription, expectedIsActive);
    ...
    @Test
    public void givenPrePersistedCategoryAndValidCategoryId_whenTryToDeleteIt_shouldDeleteCategory(){
        final var expetedName = "Filmes";
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = true;
